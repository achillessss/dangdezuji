    ...
    var a = e("./GameManager"),
      ...
      p = function (e) {
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          window.location.href = "https://mp.weixin.qq.com/mp/qrcode?scene=10000004&size=102&__biz=MzAxNDk3MjcxMw==&mid=2247489397&idx=1&sn=824992ac18f373adcc1e1398c6020a6c&send_time="
        ...
        return o(t, e), t.prototype.onLoad = function () {
          ...
          if ("downwall" == n.node.group && (t.node.parent = cc.find("Canvas/fruitNode"), 0 == this.wallColl && (d.default.Instance.Play(5, !1, 1), this.wallColl++)), "fruit" == n.node.group) {
            ...
            c == r && c < 9 && r < 9 ? (this.pengzhuangCount += 1,
              0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += this.fruitNumber + 10, // 改分数
